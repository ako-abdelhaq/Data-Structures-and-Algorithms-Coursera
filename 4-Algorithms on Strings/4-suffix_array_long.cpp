...
vector<int> sort_characters(string text ){
    vector<int> order;
...
vector<int> updateClasses(vector<int> order , vector<int> classes , int l){
    ...
    /*cout<<"update classes :  "<<l<<endl;
    for(auto e : new_classes){
        cout<<e<<" ";
    }
    cout<<endl;*/
    return new_classes;
...
vector<int> BuildSuffixArray(const string& text) {
  ...
  classes = compute_classes(text , order );
